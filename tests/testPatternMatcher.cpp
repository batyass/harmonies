...
using harmonies::rules::PatternMatcher;
...
int main()
{
    ...
    check(!PatternMatcher::matches(board, anchor, myPattern),
    ...
    check(PatternMatcher::matchesAnyRotation(board, newAnchor, myPattern),
